(function (window, angular) {
	...
	function controller(scope, element, attrs, $timeout) {
		...
		var modelChanged = function (newValue, oldValue) {
			...
			// console.log("model changed", self.modelChanged, newValue, oldValue);
			...
			// console.log("find selectedItem", self.selectedItem);
			}
			if (newValue === undefined) self.selectedItem = undefined;
			if (self.selectedItem) self.filteredDatasource = dataSource;
			// console.log("selectedItem & filteredDatasource", self.selectedItem, self.filteredDatasource);
		...
		scope.$watch("$ctrl.displayValue", function (value) {
			if (element.hasAttribute("readonly") || element.hasAttribute("disabled")) return;
			// console.log("displayValue", self.displayValue, self.selectedDisplayValue, value);
			...
			if (value === "") {
				...
				// console.log("displayValue filtered", self.filteredDatasource);
